...
<svelte:head>
	...
	<meta name="og:title" content="smart-secretary" />
</svelte:head>
<section
...
>
	...
	>
		<div class="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
			<h1 class="text-3xl text-secondary font-extrabold sm:text-5xl">
				Let's try our MASTROGPT

				<strong class="block font-extrabold text-primary"> and improve your creativity </strong>
			</h1>
